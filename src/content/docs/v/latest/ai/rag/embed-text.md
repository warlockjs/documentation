...
- [Run agent](/v/latest/ai/agents/run-agent/) — composing embedders into tools.
- [Run workflow](/v/latest/ai/orchestration/run-workflow/) — embeddings inside `run` steps.
- [Attach middleware](/v/latest/ai/reliability/attach-middleware/) — `semanticCache` uses an embedder.
- [Persist AI data](/v/latest/ai/reliability/persist-ai-data/) — vector storage guidance.
