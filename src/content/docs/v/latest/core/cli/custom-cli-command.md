...
- **`ordersRepository.list`** is the project's own repository. The recipe assumes you've built an `orders` module per the [Add a CRUD module recipe](../recipes/add-a-crud-module.md).
