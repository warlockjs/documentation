...
### CSRF Origin check for cookie auth (`@warlock.js/auth`)
...
See [Protect routes → CSRF Origin check](/v/latest/auth/guides/protect-routes/#csrf-origin-check-for-cookie-auth) for the full mechanics.
