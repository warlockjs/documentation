...
| Topic | Description |
|---|---|
| [Defining Jobs](../essentials/defining-jobs.mdx) | Full fluent API reference — every timing method |
| [Retry & Backoff](../guides/retry-backoff.mdx) | Automatic retries with optional exponential backoff |
| [Overlap Prevention](../guides/overlap-prevention.mdx) | Skip a run if the previous one is still going |
| [Timezone](../guides/timezone.mdx) | Per-job timezone support with IANA strings |
| [Events](../guides/events.mdx) | Observe the full job lifecycle |
| [Configuration](../essentials/configuration.mdx) | Tick interval, parallel execution, concurrency |
