---
title: "Memory Extended Cache Driver"
slug: v/latest/cache/memory-extended
---
...
- No eviction policy (see [LRU Memory Cache Driver](/v/latest/cache/lru-memory/))
...
- **Data disappears after restart**: This is expected. Use [File](/v/latest/cache/file/) or [Redis](/v/latest/cache/redis/) for persistence.
...
✅ **Supported (brute force).** Inherits the [memory driver's](/v/latest/cache/memory/#similarity-support) similarity behavior — O(N) cosine scan, dev-only at scale.
