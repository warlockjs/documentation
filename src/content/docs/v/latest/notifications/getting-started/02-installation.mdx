...
> Prefer to wire it by hand? `yarn add @warlock.js/notifications` (npm / pnpm work too), then create the three files yourself. The generator is the recommended path — it keeps them in sync and matches the conventions below.
