...
- [`cache.remember()`](/v/v4/cache/cache-manager/#remember-get-or-compute) — block-until-fresh sibling.
- [Stampede Prevention](/v/v4/cache/stampede-prevention/) — broader cache-miss defenses including distributed locks.
- [Tags](/v/v4/cache/tags/) — group entries for bulk invalidation.
- [Event System](/v/v4/cache/events/) — listen for `error` to monitor refresh failures.
