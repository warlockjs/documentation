...
slug: v/v4/cache/atomic-operations
---
...
See [Set Options — Conditional writes](/v/v4/cache/set-options/#conditional-writes--onconflict) for the full reference.
...
The chain lock serializes concurrent callers end-to-end within a single process — no lost updates. See [Update & Merge](/v/v4/cache/update-merge/) for details and cross-process-safety caveats.
...
- [Set Options](/v/v4/cache/set-options/) — full `onConflict` reference and distributed-lock recipe
- [Update & Merge](/v/v4/cache/update-merge/) — atomic object mutations
- [Stampede Prevention](/v/v4/cache/stampede-prevention/) — `remember()` for cache-aside lookups
- [Best Practices](/v/v4/cache/best-practices/) — production patterns
