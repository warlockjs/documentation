...
[`update()`](/v/v4/cache/update-merge/) gives you the atomic
...
**native atomic** counter via [`increment()`](/v/v4/cache/atomic-operations/),
...
job](/v/v4/cache/job-guard/), or run this on a driver/key policy that
evicts (e.g. an [`lru`](/v/v4/cache/lru-memory/) cap, or a Redis key
...
- [Atomic Operations](/v/v4/cache/atomic-operations/) — `increment()` / `decrement()`
- [Choosing a Driver](/v/v4/cache/choosing-a-driver/) — single-node vs. distributed
