...
[`cached()`](/v/v4/cache/cached/) you declare the strategy once and forget
about it.

## The simple case — `cached()`

Wrap the fetch function. Every call routes through
[`remember()`](/v/v4/cache/cache-manager/#remember-get-or-compute), so you
...
[stale-while-revalidate](/v/v4/cache/swr/). It returns the cached value
...
- [cached()](/v/v4/cache/cached/) — the higher-order wrapper in full
- [Stale-While-Revalidate](/v/v4/cache/swr/) — the resilience pattern
- [Stampede Prevention](/v/v4/cache/stampede-prevention/) — why concurrent misses collapse to one fetch
- [Cache Tags](/v/v4/cache/tags/) — bulk invalidation
