...
slug: v/v4/cache/make-your-own-cache-driver
---

`@warlock.js/cache` ships with several cache drivers out of the box:

- [Redis Cache Driver](/v/v4/cache/redis/)
- [File Cache Driver](/v/v4/cache/file/)
- [Memory Cache Driver](/v/v4/cache/memory/)
- [Memory Extended Cache Driver](/v/v4/cache/memory-extended/)
- [LRU Memory Cache Driver](/v/v4/cache/lru-memory/)
- [Null Cache Driver](/v/v4/cache/null/)

But you can easily make your own. Implement the [CacheDriver interface](/v/v4/cache/cache-driver-interface/), or extend [BaseCacheDriver](/v/v4/cache/base-cache-driver/) to inherit key parsing, TTL normalization, logging, events, and default implementations for most methods.
...
See [Cache Driver Interface](/v/v4/cache/cache-driver-interface/) for full method signatures and [Base Cache Driver](/v/v4/cache/base-cache-driver/) for available helpers.
