...
slug: v/v4/cache/memory-extended
---
...
- No eviction policy (see [LRU Memory Cache Driver](/v/v4/cache/lru-memory/))
...
- **Data disappears after restart**: This is expected. Use [File](/v/v4/cache/file/) or [Redis](/v/v4/cache/redis/) for persistence.
...
✅ **Supported (brute force).** Inherits the [memory driver's](/v/v4/cache/memory/#similarity-support) similarity behavior — O(N) cosine scan, dev-only at scale.
