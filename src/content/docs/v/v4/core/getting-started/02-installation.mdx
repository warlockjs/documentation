...
<Tabs syncKey="pm">
  <TabItem label="npm">```bash npm create warlock@latest my-app cd my-app ```</TabItem>
  <TabItem label="yarn">```bash pnpm create warlock my-app cd my-app ```</TabItem>
  <TabItem label="pnpm">```bash pnpm create warlock my-app cd my-app ```</TabItem>
</Tabs>
...
<Tabs syncKey="pm">
  ...
  <TabItem label="yarn">```bash pnpm install ```</TabItem>
...
<Tabs syncKey="pm">
  <TabItem label="npm">```bash npm run dev ```</TabItem>
  <TabItem label="yarn">```bash pnpm dev ```</TabItem>
  <TabItem label="pnpm">```bash pnpm dev ```</TabItem>
</Tabs>
