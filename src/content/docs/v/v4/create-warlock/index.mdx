...
- **Full walkthrough** → [Core · Installation](/v/v4/core/getting-started/02-installation/) — every question, the scaffolded file tree, and booting the dev server, step by step.
- **Your first endpoint** → [Core · Getting Started](/v/v4/core/getting-started/01-introduction/) — from a fresh project to a working route.
- **Scaffold as you build** → [Core · Generators](/v/v4/core/cli/generators/) — `warlock generate.module`, `generate.controller`, and the rest of the family.
