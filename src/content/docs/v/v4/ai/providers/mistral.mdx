...
[`@warlock.js/ai`](/v/v4/ai/). Mistral exposes an **OpenAI-compatible**
API, so `MistralSDK` is a **thin wrapper** over
[`@warlock.js/ai-openai`](/v/v4/ai/providers/openai/) — it does not
...
[OpenAI provider](/v/v4/ai/providers/openai/) page and the `setup-mistral`
skill.

## See also

- [OpenAI provider](/v/v4/ai/providers/openai/) — the wrapped adapter; identical wire behavior.
- [Groq provider](/v/v4/ai/providers/groq/) — another OpenAI-compatible wrapper, for Groq-hosted open models.
