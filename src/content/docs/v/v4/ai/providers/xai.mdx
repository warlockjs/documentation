...
over the [OpenAI adapter](/v/v4/ai/providers/openai/): it constructs one
...
[OpenAI](/v/v4/ai/providers/openai/) for vectors.
...
[OpenAI provider](/v/v4/ai/providers/openai/)'s `image()` for OpenAI-Images
generation.

## See also

- [OpenAI provider](/v/v4/ai/providers/openai/) — the wrapped adapter; full wire / streaming / structured-output / multipart surface applies here.
