...
[`@warlock.js/ai`](/v/v4/ai/) — open models (Llama, GPT-OSS,
...
[`@warlock.js/ai-openai`](/v/v4/ai/providers/openai/): it owns an internal
...
[OpenAI provider](/v/v4/ai/providers/openai/) or Google adapter for
...
[OpenAI provider](/v/v4/ai/providers/openai/) page and the `setup-groq`
skill.

## See also

- [OpenAI provider](/v/v4/ai/providers/openai/) — the wrapped adapter; full wire / streaming / structured-output detail.
- [Mistral provider](/v/v4/ai/providers/mistral/) — another OpenAI-compatible wrapper, for the Mistral model families.
- [`@warlock.js/ai`](/v/v4/ai/) — passing the model into `ai.agent({ ... })`.
