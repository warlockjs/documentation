...
- [Use AI tools](/v/v4/ai/tools/use-ai-tools/) — the built-in web / HTTP / calculator / date-time belt you can consume or expose.
- [Use a workspace](/v/v4/ai/tools/use-workspace/) — a workspace whose `tools.all()` is a natural `serve` source.
- [Run agent](/v/v4/ai/agents/run-agent/) — running the agent that consumes the adapted tools.
