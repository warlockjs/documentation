...
- **The model client.** OpenAI's SDK, Anthropic's, Bedrock's — each lives in a sibling adapter package. See [Pick a provider](/v/v4/ai/getting-started/03-pick-a-provider/).
...
- [Installation](/v/v4/ai/getting-started/02-installation/) — the install steps for standalone and Warlock.js contexts.
- [Pick a provider](/v/v4/ai/getting-started/03-pick-a-provider/) — comparison across the five adapters.
- [Your first agent](/v/v4/ai/getting-started/04-your-first-agent/) — runnable five-minute walkthrough.
