...
- [Orchestrator with production stores](/v/v4/ai/recipes/orchestrator-production-stores/) — wiring `ai.checkpoint.pg` + `ai.snapshot.redis` with dev-owned clients and the migration.
- [Orchestrator as a tool](/v/v4/ai/recipes/orchestrator-as-tool/) — nesting this bot inside a concierge agent.
