...
- [Basic agent](/v/v4/ai/recipes/basic-agent/) — the single-run agent this batch fans out.
- [Cost tracking](/v/v4/ai/recipes/cost-tracking/) — turning `usage` into a dashboard.
