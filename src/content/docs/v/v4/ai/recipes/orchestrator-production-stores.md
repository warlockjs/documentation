...
- [Stateful refund support bot](/v/v4/ai/recipes/orchestrator-stateful-support-bot/) — the orchestrator these stores back, end to end.
- [Orchestrator as a tool](/v/v4/ai/recipes/orchestrator-as-tool/) — nesting a stored orchestrator inside an agent.
