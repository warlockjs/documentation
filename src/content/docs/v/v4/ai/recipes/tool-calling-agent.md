...
- [Define tools](/v/v4/ai/tools/define-tools/) — the tool factory in depth.
- [Silent tools recipe](/v/v4/ai/recipes/silent-tools/) — `mode: "silent"` patterns and provider behavior.
- [Streaming tool guard](/v/v4/ai/recipes/streaming-tool-guard/) — recovering tool calls leaked as text.
