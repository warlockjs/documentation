...
- [Basic agent](/v/v4/ai/recipes/basic-agent/) — the agent shape under evaluation.
- [Deterministic supervisor tests](/v/v4/ai/recipes/dx-deterministic-supervisor-tests/) — fast, no-LLM tests for multi-agent flows.
