...
- [Embed text](/v/v4/ai/rag/embed-text/) — the embedder primitive.
- [Define tools](/v/v4/ai/tools/define-tools/) — wrapping retrieval as a tool.
- [Persist AI data](/v/v4/ai/reliability/persist-ai-data/) — driver catalog.
