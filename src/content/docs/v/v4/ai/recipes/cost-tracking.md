...
- [Pick a provider](/v/v4/ai/getting-started/03-pick-a-provider/) — pricing configuration.
- [Run agent](/v/v4/ai/agents/run-agent/) — `usage` on the result envelope.
- [Attach middleware](/v/v4/ai/reliability/attach-middleware/) — the budget built-in and custom middleware.
