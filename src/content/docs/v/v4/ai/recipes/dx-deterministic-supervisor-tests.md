...
- [Self-consistency voting](/v/v4/ai/recipes/dx-self-consistency-voting/) — the fan-out supervisor these matchers test.
- [Eval in CI](/v/v4/ai/recipes/dx-eval-in-ci/) — the complementary LLM-backed quality suite.
