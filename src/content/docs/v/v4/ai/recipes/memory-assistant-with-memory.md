...
- [Semantic recall of past answers](/v/v4/ai/recipes/memory-semantic-recall/) — store and recall Q&A pairs via cache similarity.
- [RAG with cache similarity](/v/v4/ai/recipes/rag-with-cache-similarity/) — the same `.similar()` delegation, applied to a knowledge base.
