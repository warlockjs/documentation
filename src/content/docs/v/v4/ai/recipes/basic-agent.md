...
- Add a tool — see [Tool-calling agent](/v/v4/ai/recipes/tool-calling-agent/).
- Add RAG — see [RAG with cache similarity](/v/v4/ai/recipes/rag-with-cache-similarity/).
- Add cost tracking dashboard — see [Cost tracking](/v/v4/ai/recipes/cost-tracking/).

## Related

- [Run agent](/v/v4/ai/agents/run-agent/) — the full API surface.
- [Write system prompts](/v/v4/ai/prompts/write-system-prompts/) — composable prompts.
- [Handle errors](/v/v4/ai/reliability/handle-errors/) — the full error hierarchy.
