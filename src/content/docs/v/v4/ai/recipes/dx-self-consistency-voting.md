...
- [Deterministic supervisor tests](/v/v4/ai/recipes/dx-deterministic-supervisor-tests/) — test this supervisor without spending tokens.
- [Basic agent](/v/v4/ai/recipes/basic-agent/) — the solver agent being fanned out.
