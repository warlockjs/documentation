...
- [Observability — wire Panoptic](/v/v4/ai/recipes/observability-wire-panoptic/) — attach the subscriber and the store query basics.
- [Observability — export OTel & Langfuse](/v/v4/ai/recipes/observability-export-otel-langfuse/) — ship traces to a backend and aggregate at warehouse scale.
- [Cost tracking](/v/v4/ai/recipes/cost-tracking/) — configuring `pricing` and the `usage.cost` per-channel shape.
