...
This page is the mental model. For the API surface and authoring guide see [Attach middleware](/v/v4/ai/reliability/attach-middleware/).
...
- [Attach middleware](/v/v4/ai/reliability/attach-middleware/) — API surface, authoring rules, ordering invariants.
- [Handle errors](/v/v4/ai/reliability/handle-errors/) — `BudgetExceededError`, `GuardrailViolationError`.
- [Persist AI data](/v/v4/ai/reliability/persist-ai-data/) — `defaultStore` for semantic cache.
