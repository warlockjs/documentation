...
- [Run agent](/v/v4/ai/agents/run-agent/) — composing embedders into tools.
- [Run workflow](/v/v4/ai/orchestration/run-workflow/) — embeddings inside `run` steps.
- [Attach middleware](/v/v4/ai/reliability/attach-middleware/) — `semanticCache` uses an embedder.
- [Persist AI data](/v/v4/ai/reliability/persist-ai-data/) — vector storage guidance.
