...
- [Run agent](/v/v4/ai/agents/run-agent/) — `AgentResult.error`.
- [Run workflow](/v/v4/ai/orchestration/run-workflow/) — `WorkflowError` subclasses.
- [Run orchestrator](/v/v4/ai/orchestration/run-orchestrator/) — `OrchestratorDriftError`, `OrchestratorConfigError`.
- [Planner](/v/v4/ai/architecture-concepts/planner/) — `PlannerPlanInvalidError`, `PlannerCancelledError`.
- [Define tools](/v/v4/ai/tools/define-tools/) — `ToolExecutionError` wrapping.
- [Log AI calls](/v/v4/ai/observability/log-ai-calls/) — error logging.
